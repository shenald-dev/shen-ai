...
// ============================================================
// SHEN AI — Custom Provider (OpenAI-compatible API)
// ============================================================
...
export class CustomProvider implements IProvider {
    ...
    initialize(config: ProviderConfig): void {
        ...
        logger.info(`Custom provider initialized with model: ${config.model} at ${config.baseUrl}`);
    }
    ...
    async sendMessage(
        ...
        if (!this.client || !this.config) {
            throw new Error("Custom provider not initialized. Call initialize() first.");
        }
